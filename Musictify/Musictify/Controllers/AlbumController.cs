...
namespace Musictify.Controllers
{
    ...
    public class AlbumController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlbumID,AlbumName,ImageUrl,ReleaseDate,Rate,CategoryID")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlbumID,AlbumName,ImageUrl,ReleaseDate,Rate,CategoryID")] Album album)
        {
            if (id != album.AlbumID)
            {
                return NotFound();
