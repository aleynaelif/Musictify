...
namespace Musictify.Controllers
{
    ...
    public class PlaylistController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlaylistID,PlaylistName,ImageUrl,PlaylistDescription")] Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaylistID,PlaylistName,ImageUrl,PlaylistDescription")] Playlist playlist)
        {
