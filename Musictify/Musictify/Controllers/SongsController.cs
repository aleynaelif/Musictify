...
namespace Musictify.Controllers
{
    ...
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SongsID,SongsName,Collab,Lyrics,YoutubeLink,AlbumID")] Songs songs)
        {
            ...
            ViewData["AlbumID"] = new SelectList(_context.Album, "AlbumID", "AlbumName", songs.AlbumID);
            return View(songs);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SongsID,SongsName,Collab,Lyrics,YoutubeLink,AlbumID")] Songs songs)
        {
            if (id != songs.SongsID)
            {
                return NotFound();
